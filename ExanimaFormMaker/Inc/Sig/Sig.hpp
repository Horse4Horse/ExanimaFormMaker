...
struct Sig
{
    ...
    static_assert(Holder<int, Cmp::Eq, 1, 2, 3>::k_tag == Tag::pkg, "Assert error");
    ...
    static_assert(Holder<int, Cmp::Eq>::k_tag == Tag::any, "Assert error");
    ...
    static_assert(Holder<int, Cmp::Eq, 1>::k_tag == Tag::val, "Assert error");
